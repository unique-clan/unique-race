...
// Unique
MACRO_CONFIG_INT(SvHealthAndAmmo, sv_health_and_ammo, 0, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Whether tees take damage and have limited ammo")
MACRO_CONFIG_INT(SvKillGrenades, sv_kill_grenades, 0, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Kill grenades on player death")
MACRO_CONFIG_INT(SvFastcap, sv_fastcap, 0, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Whether fastcap mode is turned on")
...
MACRO_CONFIG_INT(SvShorts, sv_shorts, 0, 0, 1, CFGFLAG_SERVER | CFGFLAG_GAME, "Whether shorts is turned on (e.g. hiding leaderboards and stuff)")
...
// Unique shorts
MACRO_CONFIG_INT(SvAuthorTime, sv_author_time, 0, 0, 9999999, CFGFLAG_SERVER | CFGFLAG_GAME, "Author time in ms")
